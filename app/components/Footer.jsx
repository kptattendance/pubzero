...
export default function Footer() {
  return (
    <footer className="bg-black text-white border-t border-white/10">
      {/* MAIN FOOTER */}
      <div className="max-w-7xl mx-auto px-6 md:px-16 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 text-center md:text-left">
        {/* 🔥 COLUMN 1 — BRAND */}
        ...
        {/* 🔥 COLUMN 3 — EXPLORE (HIDDEN ON MOBILE) */}
      ...
      {/* 🔻 BOTTOM BAR */}
      <div className="border-t border-white/10 py-6 px-6 md:px-16 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500 text-center">
